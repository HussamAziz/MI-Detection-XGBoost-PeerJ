...
This study was conducted in accordance with the ethical standards of the institutional research committee of the University of Hail. The study protocol was submitted for ethical review to the Institutional Review Board (IRB) of the University of Hail, Hail, Saudi Arabia. Given the retrospective, de-identified nature of the dataset---where all patient identifiers were replaced with cryptographic hashes prior to analysis---and in accordance with institutional data governance policy, informed consent was not required. The IRB approval number and documentation are provided as confidential supplemental material.
...
The de-identified clinical dataset used in this study cannot be publicly shared due to institutional data governance policies and patient privacy restrictions. However, the dataset is available to reviewers and editors as a confidential supplemental file submitted alongside this manuscript. The full analysis code is publicly available at: https://github.com/HussamAziz/MI-Detection-XGBoost-PeerJ (DOI: 10.5281/zenodo.[ZENODO\_ID]).
...
All code used in this study, including data preprocessing, temporal feature engineering, nested cross-validation, and model training scripts, is available at: https://github.com/HussamAziz/MI-Detection-XGBoost-PeerJ. A permanent archived version is available via Zenodo (DOI: 10.5281/zenodo.[ZENODO\_ID]).
