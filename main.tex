...
% NOTE: Re-export Figure 1 at minimum 600 DPI before final submission
\begin{figure}[ht]
\centering
\includegraphics[width=\textwidth, keepaspectratio]{fig_workflow.png}
...
This study was conducted in accordance with the ethical standards of the Institutional Review Board (IRB) of the University of Hail, College of Computer Science and Engineering, Hail 2440, Saudi Arabia (IRB Approval Number: IRB-UOH-2024-CS-001). The study was retrospective in nature, utilizing a de-identified clinical dataset in which all direct and indirect patient identifiers were replaced with cryptographic hashes prior to any analysis. The IRB of the University of Hail determined that individual informed consent from participants was not required, given the retrospective, fully de-identified design of the study and in accordance with institutional data governance policy. A copy of the original IRB approval letter and the formal waiver of informed consent are provided as confidential supplemental files accompanying this submission.

\subsection*{Use of Artificial Intelligence Tools}

The authors used Claude (claude-sonnet-4-6, Anthropic, https://claude.ai/) to assist with grammar correction and manuscript editing during preparation of this submission. No AI tool was used for data collection, analysis, result generation, figure creation, or scientific interpretation. All scientific content, methodology, experimental design, analysis, and conclusions are entirely the authors' own work.
...
The de-identified clinical dataset used in this study is provided as a confidential supplemental file (labeled ``raw data'') submitted alongside this manuscript for review by the Academic Editor and peer reviewers. The dataset cannot be made publicly available due to institutional data governance policies and patient privacy restrictions of the University of Hail. The dataset is provided in CSV format and contains all variables used in the analysis. The full analysis code is publicly available at: \url{https://github.com/HussamAziz/MI-Detection-XGBoost-PeerJ} (Zenodo DOI: 10.5281/zenodo.[ZENODO\_ID]).
...
All code used in this study---including data preprocessing, temporal feature engineering, nested cross-validation, model training, threshold optimization, and figure generation---is publicly available at: \url{https://github.com/HussamAziz/MI-Detection-XGBoost-PeerJ}. A permanently archived version with a citable DOI is available via Zenodo (DOI: 10.5281/zenodo.[ZENODO\_ID]). The repository includes the Jupyter notebook \texttt{MI\_NestedCV\_4Models\_Target098.ipynb} with full reproducible code, the \LaTeX{} source files \texttt{main.tex} and \texttt{references.bib}, all figures, and a \texttt{requirements.txt} specifying all software dependencies.
